...
const CertificateStudio = (() => {
  ...
  async function css() {
    ...
    const [faces, extra] = await Promise.all([
      ...
      fetch("certificate.css?v=snake2").then((r) => r.text()),
    ]);
